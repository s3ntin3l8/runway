...
def test_accumulator_adds_delta(session: Session):
    ...
    accumulator.process_delta(
        provider_id="test", account_id="acc1", sidecar_id="s1",
        unit_type="tokens", delta_value=100.0, timestamp="2026-05-03T12:00:00Z"
    )
    
    # Second report
    accumulator.process_delta(
        provider_id="test", account_id="acc1", sidecar_id="s1",
        unit_type="tokens", delta_value=50.0, timestamp="2026-05-03T12:05:00Z"
    )
